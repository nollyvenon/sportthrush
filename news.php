...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Latest Updates & News | <?=$site_name;?></title>
				...
				<div class="container clearfix">
					...
					<div class="postcontent nobottommargin clearfix">
						...
						<div id="posts" class="post-grid grid-container grid-2 clearfix" data-layout="fitRows">
							...
							<?php
							if(isset($news) && !empty($news)) { foreach ($news as $row) {
							?>
							<div class="entry clearfix">
									...
									<div class="fslider" data-arrows="false" data-lightbox="gallery">
										<div class="flexslider">
											<div class="slider-wrap">
												<?php
												$post_images = $client_operation->get_gallery($row['news_id']);
												if(isset($post_images) && !empty($post_images)) { foreach ($post_images as $row22) {
													$image_url = $row22['image_url'];
												?>
												<div class="slide"><a href="images/news/<?=$row22['image_url'];?>" data-lightbox="gallery-item"><img class="image_fade" src="images/news/<?=$row22['image_url'];?>" alt="<?=$title;?>"></a></div>
												<?php } }?>
											</div>
										</div>
									</div>
								...
								<div class="entry-title">
									<h2><a href="news_det?sid=<?=$row['news_id'];?>"><?=$row['news_title'];?></a></h2>
								</div>
								...
								<div class="entry-content">
									<p><?=$row['excerpts'];?></p>
									<a href="news_det?sid=<?=$row['news_id'];?>" class="more-link">Read More</a>
								</div>
							</div>
							<?php } } ?>
